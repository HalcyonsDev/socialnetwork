...
public class LoggingAspect {
    ...
    @AfterReturning(pointcut = "execution(* com.halcyon.authservice.service.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.halcyon.authservice.service.*.*(..))", throwing = "ex")
